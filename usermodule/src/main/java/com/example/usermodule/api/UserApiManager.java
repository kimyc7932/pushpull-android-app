...
public class UserApiManager {
	...
	// lesc0
	public static String deleteSubAccountToken(String openId)throws BusinessException{
		HashMap<String, Object> paramsMap = new HashMap<String, Object>();
		paramsMap.put("token", TokenHelper.getInstance().accessToken);
		paramsMap.put("openid", openId);
		JsonObject json = HttpSend.execute(paramsMap, CONST.DELETE_SUB_ACCOUNT,TIME_OUT);
