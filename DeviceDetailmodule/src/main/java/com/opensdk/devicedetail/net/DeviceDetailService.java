...
public class DeviceDetailService {
    ...
    public void setDeviceCameraStatus(final String deviceId, final String channelId, final String enableType, final boolean enable) {
        new BusinessRunnable(new LCBusinessHandler() {
            ...
            public void doBusiness() throws BusinessException {
                try {
                    DeviceInfoOpenApiManager.setDeviceCameraStatus(deviceId, channelId, enableType,enable);
