...
public class DeviceInfoOpenApiManager {
    ...
    // lesc0, enableType: localRecord, motionDetect
    public static boolean setDeviceCameraStatus(String deviceId, String channelId, String enableType, boolean enable) throws BusinessException{
        ...
        JsonObject json = HttpSend.execute(paramsMap, MethodConst.METHOD_SET_DEVICE_STATUS,TIME_OUT);
        return true;
    }
