package com.opensdk.devicedetail.view;
...
public class LcDetailProgressBar extends ProgressBar {
    ...
    public LcDetailProgressBar(Context context) {
        this(context, null);
    }

    public LcDetailProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LcDetailProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
