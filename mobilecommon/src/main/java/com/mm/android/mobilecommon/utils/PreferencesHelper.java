...
public class PreferencesHelper {
    private final static String PRENAME = "lc_data";
    ...
    /**
     * If no Key exists, 0 is returned
     * @param Key
     *
     * 若不存在Key，则返回0
     * @param Key
    ...
    /**
     * If no Key exists, false is returned
     * @param Key
     *
     * 若不存在Key，则返回 false
     * @param Key
    ...
    /**
     * New message push module, professional default return true
     * @param Key
     *
     * 新消息推送模块,专业默认返回true的
     * @param Key
