package com.pushpull.camapp.tools;
...
public class RoundedCornersTransform implements Transformation {
    ...
    /**
     * The part that needs to be rounded
     * @param leftTop     The upper left corner
     * @param rightTop    The upper right corner
    ...
    /**
     * The rounded transform
     * @param context context
     * @param radius  The rounded amplitude
     *
     * 圆角变换
     * @param context 上下文
     * @param radius  圆角幅度
