...
public class DeviceAddOpenApiManager {
    ...
    public static boolean deleteUserPermission(String openId, String deviceId,String channelId) throws BusinessException{
        HashMap<String, Object> paramsMap = new HashMap<String, Object>();
        paramsMap.put("openid", openId);
        paramsMap.put("deviceId", deviceId);
        paramsMap.put("channelId", channelId);
        paramsMap.put("token", TokenHelper.getInstance().accessToken);
        HttpSend.execute(paramsMap, CONST.DELETE_DEVICE_PERMISSION,TIME_OUT);
        return true;
    }

    public static boolean deleteDevicePermission(String openId, String deviceId) throws BusinessException{
        HashMap<String, Object> paramsMap = new HashMap<String, Object>();
        paramsMap.put("openid", openId);
        paramsMap.put("deviceId", deviceId);
        paramsMap.put("token", TokenHelper.getInstance().accessToken);
    ...
    public static boolean clearPolicy(AddDevicePolicyData req)throws BusinessException{
        String jsonParam = new Gson().toJson(req);
        HttpSend.execute(jsonParam, CONST.CLEAR_POLICY,TIME_OUT);
        return  true;
    }
